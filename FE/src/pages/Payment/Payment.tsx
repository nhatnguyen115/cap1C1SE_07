...
const PaymentPage: React.FC = () => {
  ...
  return (
    <div>
      ...
      {isMember && (
        <div>
          <div className="max-w-xl text-base mx-auto bg-gradient-to-br from-indigo-50 to-white p-6 rounded-2xl shadow-lg border border-indigo-100">
            ...
            <div className="space-y-3 text-gray-700">
              ...
              <div className="flex items-center justify-center gap-2">
                ...
                {userMembership?.price.toLocaleString()} đ
              </div>
              <div className="flex items-center justify-center gap-2">
                <FaClock className="text-blue-500" />
                <span className="font-medium">Thời hạn:</span>{" "}
                {userMembership?.durationDays} ngày
              </div>
              <div className="flex items-center justify-center gap-2">
              ...
              <div className="flex items-center justify-center gap-2">
                ...
                {userMembership?.status ?? "Chưa xác định"}
              </div>
            </div>
          </div>
