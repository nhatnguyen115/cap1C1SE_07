...
const PracticeResultDetailsPage: React.FC = () => {
                                        ...
                                        return (
                                            <div key={question.id} className="mb-6"
                                                ...
                                                <MediaComponent
                                                    ...
                                                    url={question.url}
                                                />
                                                {detail.part.questionType === QUESTION_TYPE.MULTIPLE_CHOICE ? (
                                                ...
                                                {detail.part.questionType === QUESTION_TYPE.AUDIO_BASED ? (
                                                    <div className="mt-4">
                                                        <p className="text-sm font-medium text-gray-600">Bạn đã nói:</p>
                                                        <p className="text-base text-black italic">{question.selectedAnswer}</p>
                                                    </div>
                                                ) : null}
                                                {detail.part.questionType === QUESTION_TYPE.FILL_IN_BLANK ? (
                                                    <div className="mt-4">
                                                        <p className="text-base text-black italic">{question.selectedAnswer}</p>
                                                        <p className="text-base text-blue-600 italic">{question.correctAnswer}</p>
                                                    </div>
                                                ) : null}
                                                {detail.part.questionType === QUESTION_TYPE.ESSAY ? (
                                                    <div className="mt-4">
                                                        <p className="text-base text-black italic">{question.selectedAnswer}</p>
                                                    </div>
                                                ) : null}
...
export default PracticeResultDetailsPage