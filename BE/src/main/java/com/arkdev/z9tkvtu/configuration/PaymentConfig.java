...
public class PaymentConfig {
    ...
    public static String vnp_TmnCode = "O76SSC22";
    public static String secretKey = "0BPGDFNKSQNGU3N1WZFM01WE6AX0GAOC";
    ...
    public static String hashAllFields(Map<?, ?> fields) {
        List fieldNames = new ArrayList<Object>(fields.keySet());
